...
export class SmartAudioService {
  ...
  public cargarAudios() {
    this.preload('izquierda', 'assets/sonidos/fire.mp3');
    this.preload('derecha', 'assets/sonidos/siren.mp3');
    this.preload('vertical', 'assets/sonidos/alarm_clock.mp3');
    this.preload('horizontal', 'assets/sonidos/warning_siren.mp3');
  }
